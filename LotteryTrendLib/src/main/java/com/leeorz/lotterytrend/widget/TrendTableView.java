package com.leeorz.lotterytrend.widget;
...
import com.leeorz.lotterytrend.UnitUtil;
import com.leeorz.lotterytrend.callbak.ScrollChangeCallback;
import com.leeorz.lotterytrend.lotterytrendlib.R;
...
public class TrendTableView extends LinearLayout implements ScrollChangeCallback {
    ...
    public void bindTableHeaderData(List<TableHeaderBean> tableHeaderBeans){
        ...
        for (TableHeaderBean bean : tableHeaderBeans){
            ...
            llLayout.setLayoutParams(new LinearLayout.LayoutParams(UnitUtil.dp2px(getContext(),bean.getWidth()),deltaDp));
